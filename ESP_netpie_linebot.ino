...
const char* ssid     = "ASUS"; //change this to your SSID
const char* password = "khamnoun"; //change this to your PASSWORD

const char* host = "your linebot server";//change this to your linebot server ex.http://numpapick-linebot.herokuapp.com/bot.php
#define APPID   "1653827698"     //change this to your APPID
#define KEY     "uf00004aab9254c39ade77e1b2a0772d0"     //change this to your KEY
#define SECRET  "9245251dfb0444cbcf795028607becb1"     //change this to your SECRET
